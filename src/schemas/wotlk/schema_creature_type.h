#ifndef SCHEMA_CREATURE_TYPE_H
#define SCHEMA_CREATURE_TYPE_H

#include "dbc_schema.h"

static const DbcFieldDef creature_type_fields[] = {
...
static const DbcSchema schema_creature_type = {
    "CreatureType",
    creature_type_fields,
    sizeof(creature_type_fields) / sizeof(creature_type_fields[0])
};
