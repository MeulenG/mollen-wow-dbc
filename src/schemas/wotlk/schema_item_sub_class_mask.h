#ifndef SCHEMA_ITEM_SUB_CLASS_MASK_H
#define SCHEMA_ITEM_SUB_CLASS_MASK_H

#include "dbc_schema.h"

static const DbcFieldDef item_sub_class_mask_fields[] = {
    { "ClassID",       DbcFieldType::UInt32 },
    { "Mask",          DbcFieldType::UInt32 },
...
static const DbcSchema schema_item_sub_class_mask = {
    "ItemSubClassMask",
    item_sub_class_mask_fields,
    sizeof(item_sub_class_mask_fields) / sizeof(item_sub_class_mask_fields[0])
};
