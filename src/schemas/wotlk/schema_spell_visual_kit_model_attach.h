...
static const DbcFieldDef spell_visual_kit_model_attach_fields[] = {
    ...
    { "ParentSpellVisualKitID", DbcFieldType::UInt32, DbcSemantic::ForeignKey, "parentspellvisualkit", "Visuals" },
    { "SpellVisualEffectNameID", DbcFieldType::UInt32, DbcSemantic::ForeignKey, "spellvisualeffectname", "Visuals" },
