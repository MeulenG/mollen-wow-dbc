...
static const DbcFieldDef world_map_overlay_fields[] = {
    ...
    { "TextureName", DbcFieldType::String, DbcSemantic::Default, nullptr, "Visuals" },
    { "TextureWidth", DbcFieldType::UInt32, DbcSemantic::Default, nullptr, "Visuals" },
    { "TextureHeight", DbcFieldType::UInt32, DbcSemantic::Default, nullptr, "Visuals" },
