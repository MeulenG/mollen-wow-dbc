...
static const DbcFieldDef vehicle_fields[] = {
    ...
    { "MsslTrgtArcTexture", DbcFieldType::String, DbcSemantic::Default, nullptr, "Visuals" },
    { "MsslTrgtImpactTexture", DbcFieldType::String, DbcSemantic::Default, nullptr, "Visuals" },
    ...
    { "PowerDisplayID1", DbcFieldType::UInt32, DbcSemantic::Default, nullptr, "Visuals" },
    { "PowerDisplayID2", DbcFieldType::UInt32, DbcSemantic::Default, nullptr, "Visuals" },
    { "PowerDisplayID3", DbcFieldType::UInt32, DbcSemantic::Default, nullptr, "Visuals" },
};
