#ifndef SCHEMA_QUEST_INFO_H
#define SCHEMA_QUEST_INFO_H

#include "dbc_schema.h"

static const DbcFieldDef quest_info_fields[] = {
...
static const DbcSchema schema_quest_info = {
    "QuestInfo",
    quest_info_fields,
    sizeof(quest_info_fields) / sizeof(quest_info_fields[0])
};
