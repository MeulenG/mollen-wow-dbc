#ifndef SCHEMA_ITEM_LIMIT_CATEGORY_H
#define SCHEMA_ITEM_LIMIT_CATEGORY_H

#include "dbc_schema.h"

static const DbcFieldDef item_limit_category_fields[] = {
...
static const DbcSchema schema_item_limit_category = {
    "ItemLimitCategory",
    item_limit_category_fields,
    sizeof(item_limit_category_fields) / sizeof(item_limit_category_fields[0])
};
